...
C1 0.01micro farad (or 10 Pico farad) C2 1 micro farad, 16 or 25 volts L1 3ml LED Resistor values are expressed by color bands, plus a band for the tolerance.
...
Before connecting the power, it is VERY IMPORTANT to check that all connections are correct and that the polarity of the battery is right.
